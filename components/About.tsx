      ...
      <div style={{ maxWidth: 1280, margin: "0 auto", padding: "0 24px" }}>
        ...
        <div style={{
          ...
          <div ref={imgRef}>
            <div style={{ position: "relative", borderRadius: 20, overflow: "hidden" }}>
              ...
              <div style={{
                ...
                <div>
                  <div style={{ fontSize: "0.85rem", fontWeight: 700, color: "#0f172a" }}>Enterprise Ready</div>
                  <div style={{ fontSize: "0.72rem", color: "#64748b", marginTop: 2 }}>99.9% SLA Guaranteed</div>
                </div>
              </div>
            </div>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(3,1fr)", gap: 12, marginTop: 16 }}>
              {HIGHLIGHTS.map(h => (
                ...
                >
                  ...
                  <strong style={{ fontSize: "0.82rem", fontWeight: 700, color: "#0f172a" }}>{h.label}</strong>
                  <span style={{ fontSize: "0.7rem", color: "#94a3b8" }}>{h.sub}</span>
                </div>
              ))}
            </div>
          </div>
          ...
          <div ref={textRef} style={{ display: "flex", flexDirection: "column", gap: 20 }}>
            ...
            <p data-r style={{ fontSize: "1rem", color: "#64748b", lineHeight: 1.8 }}>
              At Daksh India, our mission is to provide top-notch IT services to small and
              mid-size businesses. We make technology work <em style={{ fontStyle: "normal", color: "#2563eb", fontWeight: 600 }}>for</em> our clients — not against them.
            </p>
            ...
            <div data-r style={{
              ...
              <div>
                <h4 style={{ fontSize: "0.95rem", fontWeight: 700, color: "#0f172a", marginBottom: 6 }}>Our Mission</h4>
                <p style={{ fontSize: "0.875rem", color: "#64748b", lineHeight: 1.7 }}>
                  To provide reliable, secure, and scalable technology infrastructure that supports
                  everyday business operations and drives growth. We don't just solve problems — we
            ...
            {/* Actions */}
            <div data-r style={{ display: "flex", gap: 12, flexWrap: "wrap", marginTop: 8 }}>
              <a href="#contact" onClick={e => { e.preventDefault(); document.querySelector("#contact")?.scrollIntoView({ behavior: "smooth" }); }}
                style={{
                  display: "inline-flex", alignItems: "center", padding: "12px 28px",
                  background: "#2563eb", color: "#fff", borderRadius: 50, textDecoration: "none",
              ...
              <a href="#services" onClick={e => { e.preventDefault(); document.querySelector("#services")?.scrollIntoView({ behavior: "smooth" }); }}
                style={{
                  display: "inline-flex", alignItems: "center", padding: "12px 28px",
                  border: "2px solid #e2e8f0", color: "#475569", borderRadius: 50,
