...
export default function Navbar() {
  ...
  const [atTop, setAtTop]       = useState(true);    // is page at very top
  ...
  return (
    <>
      ...
      <div style={{
        ...
        width: "calc(100% - 32px)",
        maxWidth: 1160,
        transition: "transform 0.4s cubic-bezier(0.4,0,0.2,1), top 0.3s ease, box-shadow 0.3s ease",
      }}>
        {/* Pill container */}
        <div style={{
          display: "flex",
          ...
          >
            ...
            <span style={{
              ...
              Daksh<span style={{ color: "#2563eb" }}>India</span>
            </span>
          </a>
            ...
            {LINKS.map(l => (
              <li key={l.label}>
                <button
                  ...
                  onMouseEnter={e => {
                    (e.currentTarget as HTMLButtonElement).style.color = atTop ? "#fff" : "#2563eb";
                    (e.currentTarget as HTMLButtonElement).style.background = atTop ? "rgba(255,255,255,0.15)" : "#eff6ff";
                  }}
                  onMouseLeave={e => {
                    (e.currentTarget as HTMLButtonElement).style.color = atTop ? "rgba(255,255,255,0.85)" : "#475569";
          ...
          <button
            ...
            onMouseEnter={e => {
              ...
              (e.currentTarget as HTMLButtonElement).style.boxShadow = "0 8px 22px rgba(37,99,235,0.45)";
            }}
            onMouseLeave={e => {
              (e.currentTarget as HTMLButtonElement).style.transform = "translateY(0)";
              (e.currentTarget as HTMLButtonElement).style.background = "#0f172a";
              (e.currentTarget as HTMLButtonElement).style.boxShadow = "0 4px 14px rgba(0,0,0,0.25)";
            }}
          >
            Get Started →
          </button>
